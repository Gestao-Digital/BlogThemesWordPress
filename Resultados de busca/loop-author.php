<div class="pg-autor">
	...
	<fieldset><legend><?php if (function_exists('get_avatar')) { echo get_avatar( get_the_author_meta('email'), '100' ); }?></legend>
	...
	<!-- Título do post -->
		...
		em <?php echo get_the_time('d/m/Y H:i'); ?> - <?php the_category('&'); ?><br>
	<!-- Autor -->
	<?php endwhile; ?>
	<div class="navegacao">
